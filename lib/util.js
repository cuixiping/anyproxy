...
function setAnyProxyHome(dirPath) {
	anyproxyHome = path.resolve(dirPath);
}
module.exports.setAnyProxyHome = setAnyProxyHome;

function getAnyProxyHome() {
  const home = anyproxyHome || path.join(getUserHome(), '/.anyproxy/');
